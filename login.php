...
<div class="Login-container">
    ...
    <h1>Welcome<p>The world, as we know it, encompasses an intricate<br> tapestry of ecosystems, cultures, histories, and<br> phenomena that together form the intricate<br>mosaic of human existence.Spanning vast continents,<br> oceans, and skies, the world is a sphere of immense <br>diversity, both in its physical landscapes and <br>its human inhabitants.</p></h1>
    <p></p>
    </div>
...
body::before {
            content: "";
            background: url('mayon3.png') no-repeat center center;
            background-size: cover;
            position: absolute;
            top: 0;
            left: 0;
